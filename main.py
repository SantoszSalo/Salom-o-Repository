...
nv_funcionario = FuncionarioDAO(client).to_model({
    ...
    'pnome': 'Lucas',
    'unome': 'Silva',
    'data_nasc': '1990-08-19',
    'endereco': 'Macau - RN',
    'salario': 3500.00,
    'cpf_supervisor': '55566677788',
...
print(create)
'''
# Lendo todos os funcionarios (READ ALL)
print("-----Funcionarios-----")
...
# Lendo todos os departamentos (READ ALL)
...
print("-----Departamento único lido-----")
print(d)


# Lendo apenas um funcionario
f = funcionario_dao.read('cpf', '55566677788')
